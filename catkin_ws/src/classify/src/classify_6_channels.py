...
class classify_pcl():
	def __init__(self):
		...
		self.model_def = self.model_Base_Dir + self.model_name.lower() + '_6_channels.prototxt'
		self.model_weights = self.model_Base_Dir + self.model_name.lower() + '_6_channels.caffemodel'
